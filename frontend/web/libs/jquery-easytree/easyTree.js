        ...
        this.each(function () {
            ...
            $.each($(easyTree).find('ul > li'), function() {
                ...
                if($(this).is('li:has(ul)')) {
                    ...
                    $(children).remove();
                    text = $(this).text();
                    $(this).html('<span> <i></i> <img src="/images/icon-tree.png"> <p style="display:inline-block; margin-bottom:0"></p> </span>');
                    $(this).find(' > span > i').addClass('fa fa-angle-down');
                    $(this).find(' > span > p').text(text);
                    $(this).append(children);
                }
                else {
                    text = $(this).text();
                    $(this).html('<span><img src="/images/icon-tree.png"> <a href="javascript: void(0);"></a> </span>');
