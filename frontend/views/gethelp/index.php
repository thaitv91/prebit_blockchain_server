...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="alert alert-danger">
            Your Fee is not enough to perform this action <?=Html::a('Fee', '/token/index/');?> <?=Yii::$app->languages->getLanguage()['to_continue']?>
        </div>  
    </div>
</div>    
<?php }?>      		
        ...
        <div class="bg-trans-white">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                    <h3 class="yellow-number"><?=number_format( ($user->manager_bonus + $user->referral_bonus) , 8)?> BTC</h3>
                </div><!--col-lg-5-->
                    ...
                    <div id="form-show-bonus">
                        ...
                        <?php $form = ActiveForm::begin(['id' => 'model_bonus']); ?>
                            <div class="form-group">
                                ...
                                <div type="text" class="form-control form-wallet" id="bk-wallet"><?=$address_btc[0]?></div>
                            </div>
                            <?= $form->field($model_bonus, 'amount', ['template' => '<div class="pos-re">{input}<span class="form-control-feedback" aria-hidden="true">BTC</span>{hint}{error}</div>'])->textInput(['maxlength' => true, 'placeholder' => 'Amount', 'class' => 'form-control', 'required' => 'required', 'step' => '0.001', 'type' => GhTransfer::STATUS_BONUS])->label(false) ?>
                            
                            <div class="pull-left pad0mobi">
                                <a class="btn btn-transpa btn-cancel">Requires <b><span id="tokenforgh<?=GhTransfer::STATUS_BONUS?>">0</span></b> POINT(s)</a>
                            </div>
                            <div class="pull-right btn-group">
                                <?= Html::submitButton('GET BTC', ['class' => 'btn btn-gh']) ?>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class="bg-trans-white">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                    <h3 class="yellow-number"><?=number_format($user->wallet,8);?> BTC</h3>
                </div><!--col-lg-5-->
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pad-top20">
                    <div id="form-show-main">
                        ...
                        <?php $form = ActiveForm::begin(['id' => 'model_main']); ?>
                            <div class="form-show-bk">
                                ...
                                <?= $form->field($model_main, 'amount', ['template' => '<div class="pos-re">{input}<span class="form-control-feedback" aria-hidden="true">BTC</span>{hint}{error}</div>'])->textInput(['maxlength' => true, 'placeholder' => 'Amount', 'class' => 'form-control', 'required' => 'required', 'step' => '0.001', 'type' => GhTransfer::STATUS_MAIN])->label(false) ?>
                                <!-- <div class="form-group pos-re">
                                    <input type="text" class="form-control" id="bk-wallet" placeholder="Amount to be transferred">
                                    <span class="form-control-feedback" aria-hidden="true">BTC</span>
                                </div> -->
                                
                                <div class="pull-left pad0mobi">
                                    <a class="btn btn-transpa btn-cancel">Requires <b><span id="tokenforgh<?=GhTransfer::STATUS_MAIN?>">0</span></b> POINT(s)</a>
                                </div>
                                <div class="pull-right btn-group">
                                     <?= Html::submitButton('GET BTC', ['class' => 'btn btn-gh']) ?>
                                    <button type="reset" class="btn btn-cancel">CANCEL</button>
                    ...
                    <!-- <table data-sortable class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="view-more-table"><i class="fa fa-chevron-circle-right"></i> <a href="#" title="">View more</a></td>
                            </tr>
                            <tr>
                                <td>1234567890</td>
                                <td>01/07/2016 - 12:30:15</td>
                                <td class="green-number"><strong>0.00023564 BTC</strong></td>
                                <td>Bonus Balance</td>
                                <td class="color-pending"><img src="<?= Yii::$app->params['site_url'] ?>images/icon-pending.png"> Pending</td>
                                <td class="view-more-table"><i class="fa fa-chevron-circle-right"></i> <a href="#" title="">View more</a></td>
                            </tr>
                            <tr>
                                <td>1234567890</td>
