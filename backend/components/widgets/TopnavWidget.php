                ...
                <ul class="nav ace-nav">
                    ...
                    <li class="light-blue">
                        ...
                        <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                            ...
                            <li>
                                <?=Html::a('<i class="ace-icon fa fa-user"></i>Profile', Yii::$app->urlManager->createAbsoluteUrl('/usermanagement/profile'));?>
                            </li>

                            <li class="divider"></li>

                            <li>
                                <?=Html::a('<i class="ace-icon fa fa-power-off"></i>Logout', Yii::$app->urlManager->createAbsoluteUrl('/site/logout'), ['data-method'=>'post']);?>
                            </li>
                        </ul>
                    </li>
                </ul>
