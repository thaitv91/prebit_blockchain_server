...
class TopbarWidget extends Widget
{
	...
	public function run()
    {
            ...
            <div class="container">
                <div class="navbar-collapse2">
                    <ul class="nav navbar-nav navbar-right top-navbar">
                        <!-- message -->
                        <li class="dropdown iconify hidden-xs">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?=Yii::$app->params['site_url'];?>images/global.png">
                        ...
                        <!-- notification -->
                        <li class="dropdown iconify hide-phone notify_connversation hidden-xs">
                            <a href="#" class="dropdown-toggle notify_message" data-toggle="dropdown">
                                <img src="<?=Yii::$app->params['site_url'];?>images/comment.png">
                        ...
                        <!-- profile menu -->
                        <li class="dropdown topbar-profile hidden-xs">
                        ...
                        <!-- language menu -->
                        <li class="dropdown iconify menu-language">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?=Yii::$app->params['site_url'];?>images/flag/english.png">
        ...
        <div class="sub-navi visible-xs">
            <ul class="nav navbar-nav navbar-right top-navbar">
                <!-- message -->
                <li class="dropdown iconify global">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?=Yii::$app->params['site_url'];?>images/global.png">
                        <?php if (number_format($countmessage) > 0) {
                            echo '<span class="label label-danger absolute">';
                            echo number_format($countmessage, 0, '', '.');
                ...
                <!-- notification -->
                <li class="dropdown iconify notify_connversation">
                    <a href="#" class="dropdown-toggle notify_message" data-toggle="dropdown">
                        <img src="<?=Yii::$app->params['site_url'];?>images/comment.png">
                        <span id="count_conversation" class="label label-danger absolute messages_count_<?=Yii::$app->user->identity->id?>"><?php if($count_conver > 0) { echo $count_conver;}?></span>
                    </a>
                ...
                <li class="dropdown topbar-profile">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <span class="rounded-image topbar-profile-image" style="display: none;">
                        <?php 
                        if(!empty(Yii::$app->user->identity->avatar)){
                            $src = 'uploads/users/'.Yii::$app->user->identity->avatar;
                        }else{
                        ...
                        Hi, <strong><?php echo Yii::$app->user->identity->username; ?></strong> <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                            <?=Html::a('<i class="fa fa-user"></i> My Profile', Yii::$app->urlManager->createAbsoluteUrl('/user/view/'));?>
