...
<div class="row user-profile">
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 profile-left">
                ...
                <ul class="list-unstyled list-info">
                    <li>
                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                            <img src="<?=Yii::$app->params['site_url'];?>images/users/i-rank.png" class="img-responsive"> Rank: 
                        </div>
                    ...
                    <li><div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                            <img src="<?=Yii::$app->params['site_url'];?>images/users/i-status.png" class="img-responsive"> Account Status:
                        </div>
                        <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                            <?php
                    ...
                    <li>
                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                            <img src="<?=Yii::$app->params['site_url'];?>images/users/i-phone.png" class="img-responsive"> Phone Verified: 
                        </div>
                        <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                    ...
                    <li>
                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                            <img src="<?=Yii::$app->params['site_url'];?>images/users/i-charity.png" class="img-responsive"> Charity Contribution:
                        </div>
                        <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
        ...
        <div class="statics">
            ...
            <ul class="list-unstyled list-info">
                <li>
                    <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                        <img src="<?=Yii::$app->params['site_url'];?>images/users/i-total-sh.png" class="img-responsive"> Total Deposit: 
                    </div>
                    <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                        <?=number_format( $user->getTotalSh(Yii::$app->user->identity->id) , 8)?> BTC
                    </div>
                </li>
                <li><div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                    ...
                    <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                        <?=number_format( $user->getUserGh(Yii::$app->user->identity->id), 8)?> BTC
                    </div>                                    
                </li>
                <li>
                    <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
    ...
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-right">
        <ul id="account-tab" class="nav nav-tabs">
            ...
            <li>
                <a href="#2fa-settings" data-toggle="tab">2FA Settings</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in" id="account-info">
                ...
                <div class="process-bar display_none">
                    ...
                    <div class="content-process">
                        <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 hide-mobile2">
                            <img src="<?=Yii::$app->params['site_url'];?>images/rank/i-bronze.png" class="img-responsive">
                        </div>
                        <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 hide-table">                                            
                            <div class="progress progress-sm no-rounded">
                                <span class="level-process before-p bronze">Basic</span>
                                <span class="level-process before-p silver">Advanced</span>
                                <span class="level-process before-p gold">Premier</span>
                                <span class="level-process before-p platium">Ultimated</span>
                                <span class="level-process before-p diamond">VIP</span>
                                <span class="level-process before-p master">Super VIP</span>  
                                <span class="level-process before-p grandmaster">Grandmaster</span>  
                                ...
                                <span class="level-process level-process after-p">Legendary</span>
                            </div>
                ...
                <div class="account-infomation">
                    <div class="pmb-block ng-scope">
                        <div class="pmbb-header">
                            ...
                            <div class="btn-edit">
                                <?php echo Html::a('<img src="/images/i-edit.png" class="img-responsive"> Edit', '/user/update/', ['data-pjax' => '0', 'class'=>''
                                ]) ?>
                            </div>                                         
                        </div>
                        <div class="pmbb-body p-l-30">
                            <dl class="dl-horizontal">
                                ...
                                <dd class="ng-binding"><?= $model->username ?></dd>
                            </dl>
                            <dl class="dl-horizontal">
                                <dt class="ng-binding">Full Name</dt>
                                <dd class="ng-binding"><?= $model->fullname ?></dd>
                            </dl>
                            <dl class="dl-horizontal">
                                <dt class="ng-binding">Gender</dt>
                                <dd class="ng-binding">
                                    <?php
                                    if(!empty($model->sex)){
                                        if ($model->sex == User::MALE) {
                                            echo "Male";
                                        }else{
                                            echo "Female";
                                        }
                            ...
                            <dl class="dl-horizontal">
                                <dt class="ng-binding">Date of Birth</dt>
                                <dd class="ng-binding"><?php if(!empty($model->birthday)){echo date('d/m/Y', $model->birthday); }else{echo '<i>Updating...</i>';}?></dd>
                            </dl>
                            <dl class="dl-horizontal">
                                <dt class="ng-binding">Email</dt>
                                <dd class="ng-binding"><?php if(!empty($model->email)){ echo $model->email;}else{echo '<i>Updating...</i>';}?></dd>
                            </dl>
                            <dl class="dl-horizontal">
                                <dt class="ng-binding">Mobile Number</dt>
                                <dd class="ng-binding">(+<?=$model->country->country_code;?>) <?php if(!empty($model->phone)){ echo ltrim($model->phone, '0');}else{echo '<i>Updating...</i>';}?> <a href="#" title="">Verify</a></dd>
                            </dl>
                            <dl class="dl-horizontal">
                                <dt class="ng-binding">Passport/ID Number</dt>
                                <dd class="ng-binding"><?php if(!empty($model->passport_id)){ echo $model->passport_id;}else{echo '<i>Updating...</i>';}?></dd>
                            </dl>
                            <dl class="dl-horizontal">
                                <dt class="ng-binding">Address</dt>
                                <dd class="ng-binding"><?php if(!empty($model->address)){ echo $model->address;}else{echo '<i>Updating...</i>';}?></dd>
                            </dl>
                            <dl class="dl-horizontal">
                                <dt class="ng-binding">Country</dt>
                                <dd class="ng-binding">
                                    <?php if (!empty($model->country->name)) {echo $model->country->name;}else{echo '<i>Updating...</i>';} ?>
                                </dd>
                            </dl>
                            <dl class="dl-horizontal">
                                <dt class="ng-binding">State</dt>
                                <dd class="ng-binding">
                                    <?php if (!empty($model->state_id)) { echo $model->state_id;}else{echo '<i>Updating...</i>';} ?>                                        
                                </dd>
                            </dl>
                            <dl class="dl-horizontal">
                                <dt class="ng-binding">City</dt>
                                <dd class="ng-binding"><?php if (!empty($model->city_id)) { echo $model->city_id;}else{echo '<i>Updating...</i>';} ?></dd>
                            </dl>                           
                            <dl class="dl-horizontal">
                                <dt class="ng-binding">Postcode</dt>
                                <dd class="ng-binding"><?php if (!empty($model->postcode)) { echo $model->postcode;}else{echo '<i>Updating...</i>';} ?></dd>
                            </dl>
			...
			<div class="alert alert-success" style='display:none' id='2fa_success'>
			<strong>Success!</strong> 2Fa Setting updated successfully!
			</div>
            <form class="form-horizontal">
               <div class="form-group field-user-sex">
                   <label class="col-sm-3 control-label no-padding-right" for="form-field-1">2FA Settings</label>
                   <div class="col-sm-9">
                   <select class="form-control" id="2fa-setting">
                       <option value="1" <?php if($model->fa_setting==1){ echo "selected=selected";}?>>On</option>
                       <option value="0" <?php if($model->fa_setting==0){ echo "selected=selected";}?>>Off</option>
                   </select>
                   <br>
                   <div class="form-group">
                        <div class="col-sm-12">
                        <button type="button" id="save_setting" data-id="<?php echo $model->id;?>" class="btn btn-success">SAVE CHANGE</button>
