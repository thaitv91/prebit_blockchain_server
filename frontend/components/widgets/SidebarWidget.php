        ...
        <div id="sidebar-menu">
            ...
            echo Menu::widget([
                ...
                'items' => [
                    ...
                    ['label' => '<img src="/images/icon/i-deposit.png"> Deposit<span class="pull-right"></span>', 'url' => ['/sendhelp/index'],], 
                    ['label' => '<img src="/images/icon/i-withdraw.png"> Withdraw<span class="pull-right"></span>', 'url' => ['/gethelp/index']], 
                    ['label' => '<img src="/images/icon/i-free.png"> Fee<span class="pull-right"></span>', 'url' => ['/token/index']], 
                    ['label' => '<img src="/images/icon/i-your-cash.png"> Your cash<span class="pull-right"></span>', 'url' => ['/bitwallet/index']], 
                    ['label' => '<img src="/images/icon/i-referrals.png"> Referrals<span class="pull-right"></span>', 'url' => ['referrals/index']],
                    ['label' => '<img src="/images/icon/i-network.png"> Network<span class="pull-right"></span>', 'url' => ['/downlinetree/index'],], 
                    ['label' => '<img src="/images/icon/i-direct-bonus.png"> Direct Bonus<span class="pull-right"></span>', 'url' => ['/referralsbonus/index']], 
                    ['label' => '<img src="/images/icon/i-indirect-bonus.png"> Indirect Bonus<span class="pull-right"></span>', 'url' => ['/managerbonus/index']], 
